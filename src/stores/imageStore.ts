...
export const IMAGE_CONSTANTS = {
  ...
  GENERATE_ERROR: 'IMAGE_GENERATE_ERROR',
  GENERATE_SUCCESS: 'IMAGE_GENERATE_SUCCESS',
  GET_COUNT_ERROR: 'IMAGE_GET_COUNT_ERROR',
  GET_COUNT_SUCCESS: 'IMAGE_GET_COUNT_SUCCESS',
  GET_ITEM_ERROR: 'IMAGE_GET_ITEM_ERROR',
  GET_ITEM_SUCCESS: 'IMAGE_GET_ITEM_SUCCESS',
  ...
  UPDATE_ITEM_ERROR: 'IMAGE_UPDATE_ITEM_ERROR',
  UPDATE_ITEM_SUCCESS: 'IMAGE_UPDATE_ITEM_SUCCESS',
